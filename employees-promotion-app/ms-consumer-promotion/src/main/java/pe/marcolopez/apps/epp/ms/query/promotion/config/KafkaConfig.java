...
public class KafkaConfig {
  ...
  @Bean
  public ConsumerFactory<String, PromotionEmployeeEvent> consumerFactory() {
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, PromotionEmployeeEvent> kafkaListenerContainerFactory() {
